...
const Upload = (props) => {
  ...
  return (
    <>
      <div
        onClick={handleClick}
        className="border-2 p-2 border-dashed rounded cursor-pointer"
      >
      ...
      <div className="mx-auto font-sans text-center mt-8">
        <button
          onClick={uploadClick}
          className="ml-2 bg-green-500 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded"
        >
          Upload Eventlog
        </button>
        <div className="mt-4">
