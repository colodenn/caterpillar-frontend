...
const DashboardLayout = (props) => {
    const statisticBlocks = [
        ...
        'title': 'Event count',
        'description': '1 x 1',
        'data': '{"color":"#C71585","h":1,"w":1,"name":"Event count","api": "http://localhost:5000/api/eventcount/RequestForPayment.xes","types":"number"}'
    },
    {
        'title': 'Unique Activites Count',
        'description': '1 x 1',
        'data': '{"color":"#C71585","h":1,"w":1,"name":"Event count","types":"number","api":"http://localhost:5000/api/uniqueActivitiesCount/RequestForPayment.xes"}'
    },
    {
        'title': 'Aktivity Pie Chart',
        'description': '4 x 3',
        'data': '{"color":"#C71585","h":3,"w":4,"name":"Event count","types":"piechart","api": "http://localhost:5000/api/activitesArray/RequestForPayment.xes"}'
    },
    ]
    ...
    const discoveryBlocks = [
        {
            'title': 'Petrinet',
            'description': '5 x 4',
            'data': '{"color":"#C71585","h":2,"w":7,"name":"Petrinet","api": "http://localhost:5000/uploads/petrinet/RequestForPayment.xes","types":"image"}'
        },
    ]
...
<div className="h-screen disableScroll overflow-hidden " >
        <nav className=" w-screen py-2 px-8 border-b-1 z-50 bg-white">
            ...
            <div className="">
                ...
                <img className=" my-auto bg-gray-100 rounded-full mt-0 p-3 " style={{ "width": "40px", "height": "40px"}} src="/arrow.svg" />
                </div>
...
<div className="py-2 px-3">
{
    statisticBlocks.map(el => {
        return (
        <div   className="hover:shadow rounded p-5 flex cursor-pointer droppable-element "
        draggable={true}
        unselectable="on"
